 ...
 *
 * "EchoAd" is the deliverable (58s cut). Each scene is also registered
 * inside a folder for isolated scrubbing in Remotion Studio.
 */
import "./index.css";
  ...
  return (
    <>
      ...
      <Folder name="EchoAd-Scenes">
        ...
        <Composition id="S5-Advisor" component={SceneAdvisor} durationInFrames={SCENES.advisor} {...format} />
        <Composition id="S6-Sweep" component={Scene5Sweep} durationInFrames={SCENES.sweep} {...format} />
