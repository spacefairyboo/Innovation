    ...
    <div>
      {rows.map((r, i) => (
        <div key={r.id} className="flex items-center gap-3 mb-3">
          ...
          >
            <div className="h-full rounded-e bar-grow" style={{ width: `${r.pct}%`, background: "var(--primary)", boxShadow: "0 0 12px color-mix(in srgb, var(--primary) 40%, transparent)", animationDelay: `${0.1 + i * 0.05}s` }} />
          </div>
