...
/* The illustrated presenter portrait, after the PeopleFlow reference:
   ash-blonde hair swept into a low bun, a transparent glass headset over
   the ear, and iridescent light across the collar. Idle: gentle drift,
   periodic blinks, shimmering collar light. Speaking: the jaw and lips
   move, the headset light and aura pulse, sound waves ripple from the
   mouth. Decorative (aria-hidden); honors prefers-reduced-motion.
   Used as the loading / no-WebGL fallback behind PresenterAvatar. */

export function PresenterFace({ speaking }: { speaking: boolean }) {
