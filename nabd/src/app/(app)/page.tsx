...
function mattersMost(tasks: Task[], lang: "en" | "ar", limit: number): AttentionItem[] {
      ...
      <>
        ...
        >
          ...
          <div className="flex-1 min-w-64 relative">
            ...
            <h2 className="m-0 mt-1 text-2xl font-bold text-white">{focusTeam.name[lang]}</h2>
    ...
    <>
      ...
      <div className="card mb-5">
        <div className="flex items-start gap-2 mb-3">
          ...
          <Link href="/tasks" className="text-xs font-semibold text-primary no-underline inline-flex items-center gap-0.5 shrink-0">
