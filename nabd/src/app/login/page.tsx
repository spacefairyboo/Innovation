      ...
      <div className="relative min-h-screen grid lg:grid-cols-2 items-center gap-10 px-6 py-10 lg:px-16 max-w-7xl mx-auto">
        ...
        <div className="hidden lg:flex flex-col gap-10 rise-stagger" style={{ color: "#eefaf3" }}>
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-2xl text-white [text-shadow:0_1px_10px_rgb(6_40_30/0.35)]">
              {t("appName")}
              <small className="block text-xs font-medium tracking-wider uppercase" style={{ color: "rgb(238 250 243 / 0.75)" }}>
                {t("appTag")}
              </small>
            </span>
          </div>
          ...
          <p className="m-0 text-xs inline-flex items-center gap-1.5" style={{ color: "rgb(238 250 243 / 0.7)" }}>
        ...
        <div className="w-full max-w-md mx-auto lg:me-0">
          <div className="glass-card rounded-3xl p-8 sm:p-10 page-enter">
            ...
            <p className="mt-6 mb-0 text-xs text-ink-3 leading-5 rounded-xl border border-line bg-surface-2 px-4 py-3">
