...
- **Delegation** — going away? Pick a delegate on your profile: they get an email and every open task is assigned to them, with an optional **end date** on which the tasks are assigned back to you automatically (or end it manually anytime).
